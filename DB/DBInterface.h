...
public:
  ...
  virtual bool isUserValid(const std::string& uname, const std::string& token) = 0;
  virtual bool isUserAdmin(const std::string& uname) = 0;
  virtual bool isUserModerator(const std::string& uname, int channel_id) = 0;
